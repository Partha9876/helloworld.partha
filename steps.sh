...
# --> Name it as "ConsoleHelloWorldPartha"
# --> Select default values for the rest of the options
# >> This should create the "ConsoleHelloWorldPartha" folder, and the "ConsoleHelloWorldPartha.sln" files.
...
# 2) Run the project
dotnet run --project ConsoleHelloWorldPartha
